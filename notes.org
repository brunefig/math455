...
The preimages of sets in a open cover $U$ of $f(A)$
...
:END:
***** Cloze
A subspace of {{c3::a Hausdorff space}} is {{c2::a Hausdorff space}} under {{c1::the subspace topology}}.
*** COMMENT product of Hausdorff spaces is a Hausdorff space
:PROPERTIES:
:ANKI_NOTE_TYPE: Cloze
:END:
**** Cloze
...
and let $(x,y) \neq (x',y') \in X \times Y$, assuming wlog that
$x \neq x'$.
Then $\exists U,U' \in \tau$.
